...
class ReadonlyWorkoutExerciseAdapter(
    private var items: MutableList<WorkoutExerciseData>,
    private val context: Context
) : RecyclerView.Adapter<ReadonlyWorkoutExerciseAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val setsAdapter = ReadonlyWorkoutExerciseSetsAdapter(item.sets, context)
